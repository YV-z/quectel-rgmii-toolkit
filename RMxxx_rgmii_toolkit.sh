...
if echo "$ARCH" | grep -q "aarch64"; then
    cd /tmp && wget -O RM55x_rcPCIe_toolkit.sh https://ghfast.top/https://raw.githubusercontent.com/YV-z/quectel-rgmii-toolkit/SDXPINN/RM55x_rcPCIe_toolkit.sh && chmod +x RM55x_rcPCIe_toolkit.sh && ./RM55x_rcPCIe_toolkit.sh && cd /
    exit 0
